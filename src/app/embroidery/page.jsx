...
const techniques = [
  {
    ...
    detail:
      "Sashiko through repetitive reinforcement stitching ensures precision and consistency across construction — where the technique becomes the texture.",
  ...
  },
  {
    ...
    detail:
      "Kantha through layered running stitches ensures that every surface tells the story of its making — a tradition carried forward in every piece.",
  ...
  },
  {
    ...
    detail:
      "Exquisite craftsmanship meets material excellence — where detail is not an addition, but a signature of the piece.",
    pattern: (
      <svg
        width={160}
        height={160}
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .k-intro-body {
           ...
           font-size: 15px; font-weight: 390;
          line-height: 2.3; color:#111111; letter-spacing: 0.02em;
        }
...
font-size: 15px; font-weight: 390;
        ...
        .k-quote p {
          font-family: var(--ff-sans); font-size: 15px; font-weight: 390;
          ...
          <div className="k-intro-grid">
            <div>
              <h2 className="k-intro-heading">
                A Touch ofEmbroidery,a Shade of Elegance
              </h2>
              <p className={`k-intro-body ${josefin.className}`}>
                ...
                the piece. <br /> <br /> These practices are deeply rooted in
                India’s cultural heritage and are incorporated with finesse,
                creating garments that remain connected to tradition while
                expressed with a modern sensibility. By continuing these
                techniques, DHIRAGO upholds its commitment to preserving age-old
                craftsmanship and celebrating India’s rich textile legacy,
                presenting ethical and heritage-driven making as a form of true
                luxury
              </p>
            </div>
            <div>
      ...
      {/* <section
        style={{ padding: "clamp(1rem, 8vw, 8rem) 0", background: "#FAFAF7" }}
      >
        <div
          style={{
            maxWidth: 1200,
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      ...
                      <span
                        className="tech-tab-name heading-font"
                        style={{
                          fontSize: "clamp(1rem, 2vw, 1.3rem)",
                          fontWeight: 400,
                          letterSpacing: "0.08em",
                          color:
                            active === i ? "#1C1814" : "rgba(28,24,20,0.35)",
