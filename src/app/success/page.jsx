...
useEffect(() => {
 ...
 useEffect(() => {
  const isVisited = sessionStorage.getItem("order_success");
...
const normalizedStatus = statusMap[order.status] || "confirmed";
...
const steps = ["confirmed", "packed", "shipped", "delivered"];
  ...
  // 💬 WhatsApp Message
  const whatsappLink = `https://wa.me/${order.phone}?text=Your order ${order.order_number} is confirmed!`;
