                            ...
                            >
                                ...
                                <div className="flex items-center justify-between px-6 py-5 bg-white border-b">
                                    <div className="flex items-center gap-2">
                                        <Logo />
                                        <span className="text-lg font-semibold">Dhirago</span>
                                    </div>
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="flex bg-gray-100 rounded-lg p-1 mb-5">
                                                <button
                                                    ...
                                                    className={`flex-1 py-2 rounded-md text-sm ${loginType === "mobile"
                                                ...
                                                <button
                                                    ...
                                                    className={`flex-1 py-2 rounded-md text-sm ${loginType === "email"
                                                        ? "bg-white shadow font-medium"
                                                        : "text-gray-500"
                                                        }`}
                                                >
                                            ...
                                            <form onSubmit={handleLogin} className="space-y-4">
                                                ...
                                                <button
                                                    disabled={loading}
                                                    className="w-full bg-gradient-to-r from-black to-gray-800 text-white py-2.5 rounded-lg hover:opacity-90"
                                                >
                                                    {loading
                                                        ? loginType === "mobile"
                                                            ? "Sending OTP..."
